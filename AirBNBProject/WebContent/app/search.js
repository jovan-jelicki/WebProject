...
<div>
    ...
    <div class="naslov" >
        ...
        <input type="number" min="0" onkeydown="return false" id="price2" name="search5" ref="max" v-model="data.maxPrice" v-on:change="setMax()" placeholder="Maksimalna cena po noci" >
        <input type="number" min="0" onkeydown="return false" id="rooms" v-model="data.rooms" name="search6" placeholder="Broj soba">
